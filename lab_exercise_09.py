...
class Person:
    ...
    def __init__(self, url, name, birth_year, height, mass):
        ...
        self.height = height
        self.mass = mass
        self.homeworld = None #because it's optional
    ...
    def jsonable(self):
        ...
        homeworld = None
        if self.homeworld: # if self.homeworld does != None
        ...
        return {
            ...
            'height': self.height,
            'mass': self.mass,
            'homeworld': homeworld #returns None or is a dict rep of homeworld if there is a planet instance
        }
...
def main():
    ...
    print(get_swapi_resource(ENDPOINT))
    # step 1
    swapi_luke = get_swapi_resource(ENDPOINT + '/people/', {'search': 'luke skywalker'})['results'][0]

    print(f"\nLuke Skywalker's Data From SWAPI =\n {swapi_luke}\n")
    ...
    # step 3
    tatooine_data = read_json('tatooine.json')
    #print(tatooine_data)

    # step 4
    swapi_tatooine = get_swapi_resource(ENDPOINT + '/planets/', {'search': 'Tatooine'})['results'][0]
